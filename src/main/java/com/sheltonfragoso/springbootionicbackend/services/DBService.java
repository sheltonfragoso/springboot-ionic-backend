...
import com.sheltonfragoso.springbootionicbackend.domain.ItemPedido;
...
import com.sheltonfragoso.springbootionicbackend.repositories.ItemPedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "jonasmatandofiniasse@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "jonasmatandofiniasse1@gmail.com", "32709324059", TipoCliente.PESSOAFISICA, pe.encode("123"));
